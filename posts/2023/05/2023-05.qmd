...
Instead, we can keep everything as ranges and map those ranges through the different steps. When we map a range we need to identify how ranges overlap and, in some cases, split ranges into pieces.
