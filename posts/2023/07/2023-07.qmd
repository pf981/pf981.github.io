...
You are given a list of 5 card hands and their corresponding <b class='fw-bold' style='color: #2F7E4A;'>bids</b>. <b class='fw-bold' style='color: #BE4844;'>Rank</b> each hand and calculate the winnings as the product of the <b class='fw-bold' style='color: #BE4844;'>rank</b> and <b class='fw-bold' style='color: #2F7E4A;'>bid</b>. Compute the <b class='fw-bold' style='color: #91672C;'>total winnings</b>.
...
\begin{aligned}
&{\text{Hand}} &&{\text{Bid}} &&{\text{\grey{Rank}}} &&{\text{\grey{Type}}}\phantom{\Huge{g}}&{\text{\grey{Winnings}}} &\\
&\text{32T3K}            &&\green{765}            &&\greyred{1}                       &&\text{\grey{One pair}}         &\greygreen{765} \,\grey{\times}\, \greyred{1}                &\plus\\
&\text{T55J5}            &&\green{684}            &&\greyred{4}                       &&\text{\grey{Full house}}       &\greygreen{684} \,\grey{\times}\, \greyred{4}                &\plus\\
&\text{KK677}            &&\green{28}             &&\greyred{3}                       &&\text{\grey{Two pair}}\grey{^*}       & \greygreen{28} \,\grey{\times}\, \greyred{3}                &\plus\\
&\text{KTJJT}            &&\green{220}            &&\greyred{2}                       &&\text{\grey{Two pair}}         &\greygreen{220} \,\grey{\times}\, \greyred{2}                &\plus\\
&\text{QQQJA}            &&\green{483}            &&\greyred{5}                       &&\text{\grey{Three of a kind}}  &\greygreen{483} \,\grey{\times}\, \greyred{5} \llap{\lower{0.4pc}\underline{\phantom{483 \times 5}}}               &\\
&                        &&                       &&                        &&                        &\orange{6440}                        &\\
\end{aligned}
$$
