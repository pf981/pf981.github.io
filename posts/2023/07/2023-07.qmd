...
\begin{aligned}
&{\text{Hand}} &&{\text{Bid}} &&{\text{\grey{Rank}}} &&{\text{\grey{Type}}}\phantom{\Huge{g}}&{\text{\grey{Winnings}}} &\\
&\text{32T3K}            &&\green{765}            &&\grey{1}                       &&\text{\grey{One pair}}         &765 \times 1                &\\
&\text{T55J5}            &&\green{684}            &&\grey{4}                       &&\text{\grey{Full house}}       &684 \times 4                &\\
&\text{KK677}            &&\green{28}             &&\grey{3}                       &&\text{\grey{Two pair}}\grey{^*}       & 28 \times 3                &\\
&\text{KTJJT}            &&\green{220}            &&\grey{2}                       &&\text{\grey{Two pair}}         &220 \times 2                &\\
&\text{QQQJA}            &&\green{483}            &&\grey{5}                       &&\text{\grey{Three of a kind}}  &483 \times 5                &\\
&                        &&                       &&                        &&                        &6440                        &\\
\end{aligned}
$$
