...
Finally, define `hand_bid_order` as the combination of the primary and second order. Sort the bids by their corresponding hand rank and calculate the winnings.
```{python}
