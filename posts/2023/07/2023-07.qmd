...
$$
\begin{aligned}
&\underline{\text{Hand}} &&\underline{\text{Bid}} &&\underline{\text{Rank}} &&\underline{\text{Type}} &\underline{\text{Winnings}} &\\
...
$\tiny{^{*}\text{Stronger second card than other two pair}}$
...
$$
\hspace*{\fill}\tiny{^{*}\text{Stronger second card than other two pair}}
$$
...
$$
$$
\small{\text{\textsuperscript{*} Stronger second card than other two pair}}
$$
$$
\hspace*{\fill}\small\text{\textsuperscript{*} Stronger second card than other two pair}
$$
