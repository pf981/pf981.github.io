...
### Spotting Subproblems Saves Seconds
...
<!--  2. Recognising that many of these subproblems are equivalent. So as you solve each subproblem, you keep track of the answer. When you encounter a subproblem you've seen before, just reuse the answer. -->
...
Is it the fastest? Is it the most memory efficient?
Consider the memory footprint - even though we don't have an array, we have STACK frames
-->

<!-- This grows _way_ faster than you'd expect
What about 2 dimensional problems? What about 3 or more dimensions-->
